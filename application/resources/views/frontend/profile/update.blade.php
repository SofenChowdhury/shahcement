    ...
    <div class="grid-column">
      <div class="widget-box">
        ...
        <div class="widget-box-content" style="margin-top: 9px;">
          <p class="paragraph">
            <textarea class="form-control" name="about_me" placeholder="About Me" id="about_me">{{$user_info->about_me}}</textarea>
          </p>
          <div class="information-line-list">
            ...
            <div class="information-line">
              	...
              	<p class="information-line-text">
              		<input type="text" name="website" class="form-control" style="height: 30px;" placeholder="Website Link" id="website" value="{{$user_info->website}}">
              	</p>
            </div>
          </div>
        </div>
        ...
        <div class="widget-box-content">
          <div class="information-line-list">
            ...
            <div class="information-line">
              ...
              <p class="information-line-text">
                <input type="date" name="birthday" style="border:1px solid lightgray;" id="birthday" value="{{date('Y-m-d', strtotime($user_info->birth_date))}}">
              </p>
            </div>
            <div class="information-line">
              <p class="information-line-title">Occupation</p>
              <p class="information-line-text">
                <input type="text" name="occupation" style="border:1px solid lightgray;height: 30px;" id="occupation" value="{{$user_info->occupation}}">
              </p>
            </div>
            <p class="btn btn-success" style="float: right;" onclick="submitUserInfo()">
              <i class="lni lni-database"></i> Save Data</p>
          </div>
        </div>
      </div>
    </div>
